  ...
  return (
    <>
      <div className='Split__Item'>
        <dl className='Properties'>
          <div className='Properties__Item'>
            <dt className='Properties__K'>{name.key}:</dt>
            <dd className='Properties__V'>{name.value}</dd>
          </div>
          <div className='Properties__Item'>
            <dt className='Properties__K'>{age.key}:</dt>
            <dd className='Properties__V'>{calculatedAge}</dd>
          </div>
          <div className='Properties__Item'>
            <dt className='Properties__K'>{city.key}:</dt>
      ...
      <div className='Split__Item'>
        <dl className='Properties'>
          <div className='Properties__Item'>
            <dt className='Properties__K'>{level.key}:</dt>
            <dd className='Properties__V'>{level.value}</dd>
          </div>
          <div className='Properties__Item'>
            <dt className='Properties__K'>{english.key}:</dt>
            <dd className='Properties__V'>{english.value}</dd>
          </div>
          <div className='Properties__Item'>
            <dt className='Properties__K'>{specialization.key}:</dt>
            <dd className='Properties__V'>{specialization.value}</dd>
          </div>
          <div className='Properties__Item'>
            <dt className='Properties__K'>{salary.key}:</dt>
            <dd className='Properties__V'>{salary.value}</dd>
          </div>
          <div className='Properties__Item'>
            <dt className='Properties__K'>{employment.key}:</dt>
            <dd className='Properties__V'>{employment.value}</dd>
          </div>
          <div className='Properties__Item'>
            <dt className='Properties__K'>{location.key}:</dt>
